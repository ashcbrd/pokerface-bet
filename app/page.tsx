    ...
    <main className="z-10 relative">
      ...
      <div className="flex flex-col gap-y-10 max-w-6xl mx-auto py-20">
        <img
          ...
          className="max-w-[400px] object-contain m-auto relative"
        />
        ...
        <Link href="poker-face-white-paper" className="mx-auto">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-6">
              <h2 className="font-[200] tracking-wide text-xl">
                ...
                $FACE, players gain access to exclusive benefits and privileges
                within our gaming ecosystem.
              </h2>
              <h2 className="font-[200] tracking-wide text-xl">
      ...
      <div className="py-20 black-background">
        <div className="flex flex-col items-center max-w-6xl mx-auto gap-y-10">
          ...
          <p className="text-xl text-center font-[200] max-w-3xl">
            Our online casino platform is more than just a place to play; it’s a
            gateway to an immersive and rewarding gaming experience. From
          ...
          <div className="flex flex-col justify-between h-[340px]">
            <div>
              ...
              <p className="text-xl font-[200] w-[500px] mt-2">
                When you stake your $FACE you earn USDT rewards profits from the
                Casino.
              </p>
            </div>
            <div>
      ...
      <div className="black-background py-20">
        <div className="max-w-6xl mx-auto flex flex-col gap-y-10 items-center"></div>
      </div>
    </main>
  );
}
