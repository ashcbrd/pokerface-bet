export const termsOfService = [
  {
    ...
    content: [
      ...
      "The Service is owned by MIBS NV, a limited liability company registered in Curacao with company registration number 162031, with registered address at Zuikertuintjeweg (Zuikertuin Tower), Willemstad, Curacao (“Company”), licensed in Curaçao under Gaming Services Provider N.V. license # 365/JAZ for the provision of online games of chance.",
    ],
  },
  {
    title: "General Terms",
  ...
  },
  {
    ...
    content: [
      ...
      "When placing bets you may lose some or all of your money deposited to the Service in accordance with these Terms and you will be fully responsible for that loss.",
      "When placing bets you must not use any information obtained in breach of any legislation in force in the country in which you were when the bet was placed.",
      ...
      "You must generally act in good faith in relation to us of the Service at all times and for all bets made using the Service.",
  ...
  },
  {
    ...
    content: [
      ...
      "If you are under the age of 18 years (or below the age of majority as stipulated in the laws of the jurisdiction applicable to you) or if you are not legally able to enter into a binding legal agreement with us or you acting as an agent for, or otherwise on behalf, of a person under 18 years (or below the age of majority as stipulated in the laws of the jurisdiction applicable to you);",
      "If you reside in a country in which access to online gambling to its residents or to any person within such country is prohibited.",
  ...
  },
  {
    ...
    content: [
      ...
      "We reserve the right to close or suspend any Account without prior notice and return all funds. Contractual obligations already matured will however be honored.",
      ...
      "Should you wish to close your account with us, please send an email from your Registered Email Address to our Customer Support Department via the links on the Website.",
    ],
  },
  {
    title: "Inactive Accounts",
    content: [
      "We will charge you a fee of €5 (or currency equivalent) per calendar month (Inactive Account Fee) if:",
  ...
  },
  {
    ...
    content: [
      ...
      "If you decide to accept any of our promotional or bonus offer by entering a bonus code during deposit, you agree to the Terms of Bonuses and terms of each specific bonus.",
      ...
      "Internet Gambling may be illegal in the jurisdiction in which you are located; if so, you are not authorized to use your payment card to deposit on this site. It is your responsibility to know the laws concerning online gambling in your country of domicile.",
    ],
  },
  {
    title: "Withdrawal of Funds",
    content: [
      "You may withdraw any unutilized and cleared funds held in your player account by submitting a withdrawal request in accordance with our withdrawal conditions. The minimum withdrawal amount per transaction is € 10 (or equivalent in other currency) with the exception of an account closure in which case you may withdraw the full balance.",
      "There are no withdrawal commissions if you roll over (wager) the deposit at least 1 time. Otherwise we are entitled to deduct a 8% fee with minimum sum of 4 euro (or equivalent in your account currency) in order to combat money laundering.",
      ...
      "Should you wish to withdraw funds but your account is either inaccessible, dormant, locked or closed, please contact our Customer Service Department.",
      "The maximum withdrawal amount per month is € 50,000.",
      "Please note that we cannot guarantee successful processing of withdrawals or refunds in the event if you breach the Restricted use policy stated in Clauses 3.3 and 4.",
    ],
  },
  {
    title: "Payment Transactions and Processors",
    content: [
  ...
  },
  {
    title: "Errors",
    content: [
      "In the event of an error or malfunction of our system or processes, all bets are rendered void. You are under an obligation to inform us immediately as soon as you become aware of any error with the Service. In the event of communication or system errors or bugs or viruses occurring in connection with the Service and/or payments made to you as a result of a defect or error in the Service, we will not be liable to you or to any third party for any direct or indirect costs, expenses, losses or claims arising or resulting from such errors, and we reserve the right to void all games/bets in question and take any other action to correct such errors.",
  ...
  {
    title: "Rules of Play, refunds and cancellations",
    content: [
      "The winner of an event will be determined on the date of the event’s settlement, and we will not recognize protested or overturned decisions for wagering purposes.",
      "All results posted shall be final after 72 hours and no queries will be entertained after that period of time. Within 72 hours after results are posted, we will only reset/correct the results due to human error, system error or mistakes made by the referring results source.",
      "If a match result is overturned for any reason by the governing body of the match within the payout period then all money will be refunded.",
      "If a draw occurs in a game where a draw option is offered all stakes on a team win or lose will be lost. If a draw option is not offered then everyone receives a refund in the outcome of a draw on the match. And if a draw option has not been made available, then extra time will count, if played.",
      "If a result cannot be validated by us, for instance if the feed broadcasting the event is interrupted (and cannot be verified by another source) then at our election, the wagers on that event will be deemed invalid and wagers refunded.",
      "Minimum and maximum wager amounts on all events will be determined by us and are subject to change without prior written notice. We also reserve the right to adjust limits on individual Accounts as well.",
      "Customers are solely responsible for their own Account transactions. Once a transaction is complete, it cannot be changed. We do not take responsibility for missing or duplicate wagers made by the Customer and will not entertain discrepancy requests because a play is missing or duplicated. Customers may review their transactions in the My Account section of the site after each session to ensure all requested wagers were accepted.",
      "A matchup will have action as long as the two teams are correct, and regardless of the League header in which it is placed on our Website.",
      "The start dates and times displayed on the Website for eSport matches are an indication only and are not guaranteed to be correct. If a match is suspended or postponed, and not resumed within 72 hours from the actual scheduled start time, the match will have no action and wagers will be refunded. The exception being any wager on whether a team/player advances in a tournament, or wins the tournament, will have action regardless of a suspended or postponed match.",
      ...
      "If a team is using stand-ins, the result is still valid as it was the team’s choice to use the stand-ins.",
      "Company reserves the right to remove events, markets and any other products from the Website.",
      "In-depth explanation of our sports betting rules is on the separate page: SPORTS BETTING RULES",
    ],
  },
  {
    title: "Communications and Notices",
    content: [
      "All communications and notices to be given under these Terms by you to us shall be sent using a Customer Support form on the Website.",
      ...
      "All communications and notices to be given under these Terms by either you or us shall be in writing in the English language and must be given to and from the Registered Email Address in your Account.",
  ...
  {
    title: "Matters Beyond Our Control",
    content: [
  ...
  {
    title: "Gambling By Those Under Age",
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      "We reserve the right to confiscate any funds if any fraudulent activity or bonus abuse attempt is detected.",
      "Using fraudulent game patterns to circumvent wagering of bonuses or take advantage of a certain game features is strictly forbidden and all winnings currently or due to be credited to your account will be retained.",
      "Fraudulent game pattern can be defined as any pattern of bets that is unfair and it’s sole purpose is to circumvent the terms set by the casino and help you get unfair edge against the house. Fraudulent game pattern includes, but is not limited to:",
  ...
  },
  {
    ...
    content: [
      "Any unauthorized use of our name and logo may result in legal action being taken against you.",
      "As between us and you, we are the sole owners of the rights in and to the Service, our technology, software and business systems (the “Systems”) as well as our odds.you must not use your personal profile for your own commercial gain (such as selling your status update to an advertiser); andwhen selecting a nickname for your Account we reserve the right to remove or reclaim it if we believe it appropriate.",
      "You may not use our URL, trademarks, trade names and/or trade dress, logos (“Marks”) and/or our odds in connection with any product or service that is not ours, that in any manner is likely to cause confusion among Customers or in the public or that in any manner disparages us.",
  ...
  },
  {
    title: "Your License",
    content: [
      "Subject to these Terms and your compliance with them, we grant to you a non-exclusive, limited, non transferable and non sub-licensable license to access and use the Service for your personal non-commercial purposes only. Our license to you terminates if our agreement with you under these Terms ends.",
  ...
  {
    title: "Your Conduct and Safety",
    content: [
      "For your protection and protection of all our Customers, the posting of any content on the Service, as well as conduct in connection therewith and/or the Service, which is in any way unlawful, inappropriate or undesirable is strictly prohibited (“Prohibited Behaviour”).",
      "If you engage in Prohibited Behaviour, or we determine in our sole discretion that you are engaging in Prohibited Behaviour, your Account and/or your access to or use of the Service may be terminated immediately without notice to you. Legal action may be taken against you by another Customer, other third party, enforcement authorities and/or us with respect to you having engaged in Prohibited Behaviour.",
  ...
  },
  {
    ...
    content: [
      ...
      "In the event of a dispute arising between you and us our Customer Service Department will attempt to reach an agreed solution. Should our Customer Service Department be unable to reach an agreed solution with you, the matter will be escalated to our management.",
      "Should all efforts to resolve a dispute to the Customer’s satisfaction have failed, the Customer has the right to lodge a complaint with our licensing body Gaming Services Provider N.V.",
    ],
  },
  {
    title: "Assignment",
  ...
  },
  {
    ...
    content: [
      ...
      "Poker Face Marketing LTD operates the Poker Face casino website (“Platform”). Your use of the Platform signifies acceptance of our Terms of Service, Privacy Policy, Cookie Policy, and the $PFC Token sale agreement. Please note that cryptocurrency regulations may vary by jurisdiction, and their values can fluctuate. Profits from cryptocurrency transactions may be subject to taxes in your area. This website does not constitute an offer or recommendation to buy, sell, or invest. It is your responsibility to assess whether any transaction aligns with your personal goals, financial situation, and risk tolerance. Seek advice from licensed professionals for legal, tax, insurance, or business matters. Poker Face Casino does not guarantee the performance, outcome, or return of capital for any cryptocurrencies mentioned on this site. By accessing this website and its pages, you agree to abide by the terms of the $PFC sales agreement. Keep in mind that purchasing cryptocurrencies carries inherent risks and could lead to partial or total loss.",
    ],
  },
];
